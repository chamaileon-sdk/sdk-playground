...
export default {
  ...
  methods: {
    ...
    ...mapMutations({
      ...
      deleteBtn: 'removePreviewBtn',
      updateHeaderBtnOrder: 'updatePreviewBtnOrder',
      updateBtn: 'updatePreviewBtn',
      addDD: 'addPreviewDropdown',
      addDDBtn: 'addPreviewDropdownBtn',
      updateDDBtn: 'updatePreviewDropdownBtn',
      deleteDDBtn: 'removePreviewDropdownBtn',
    }),
    updateLabel(val, id) {
  ...
  computed: {
    buttonsArr: {
      get() {
        return this.$store.getters.getPreviewBtns;
      },
      set(value) {
