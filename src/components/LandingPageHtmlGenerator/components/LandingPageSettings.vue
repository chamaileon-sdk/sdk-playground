<template>
	<div>
		...
		<p>
			...
			the most optimized output for your desired landing page.
		</p>
		<OptionWrapper>
						...
						>
							<v-card flat class="ma-0 pa-0 d-flex justify-end align-center">
								<v-select
									...
									outlined
									label="Value"
									:items="['handlebars', 'liquid', 'mustache', 'mailchimp', 'acc']"
									:hide-details="true"
									:value="item.value"
...
export default {
	...
	computed: {
		...mapGetters({ settings: "getLandingPageHtmlGeneratorSettings" }),
	...
	methods: {
		...mapMutations(["updateLandingPageHtmlGeneratorSettings", "updateInt"]),

		updateSettings(obj) {
			this.updateLandingPageHtmlGeneratorSettings(obj);
