            ...
            children: [
                ...
                children: [
                  {
                    ...
                    attrs: {
                      ...
                      sizeType: 'FIXED',
                      link: '',
                      lockDimensions: { width: 150, height: 150 },
                      altText: '',
                    ...
                    children: [
                      {
                        ...
                        children: [
                          ...
                          },
                          {
                            eid: 'G3i_ontanE',
                            type: 'text',
                            attrs: { text: '<p>10-15. Joey Barch</p>\n' },
                            style: {
                              'padding-left': '20px',
                              'padding-bottom': '15px',
                              'padding-right': '20px',
                    ...
                    children: [
                      {
                        ...
                        style: {
                          ...
                          'padding-right': '10px',
                          'padding-top': '5px',
                          a: { 'text-decoration': 'none', color: '#165bb4' },
                          'line-height': '40px',
                          color: '#165BB4',
                          'font-size': '35px',
                          'font-family':
              ...
              },
              {
                ...
                style: {
                  ...
                  'body-width': 600,
                  'content-width': 600,
                  'content-background-color': '#165BB4',
                  'content-background-repeat': 'no-repeat',
                  'content-background-position': 'center center',
                  'content-background-image': 'url()',
                  'content-margin-left': '0px',
