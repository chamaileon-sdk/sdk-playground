			...
			children: [
				...
				},
				{
					...
					style: {
						...
						"body-width": 600,
						"content-width": 600,
						"content-background-color": "#1762C5",
						"content-background-repeat": "no-repeat",
						"content-background-position": "center center",
						"content-background-image": "url()",
						"content-margin-left": "0px",
																	...
																	children: [
																		{
																			...
																			style: {
																				...
																				"border-left": "0px solid #000000",
																				"border-bottom": "0px solid #000000",
																				"border-right": "0px solid #EDF4FD",
																				"border-top": "0px solid #EDF4FD",
																				"margin-left": "0px",
																				"margin-bottom": "0px",
																				"margin-right": "0px",
																				"margin-top": "0px",
																				...
																				"border-right-width": "0px",
																				"border-right-style": "solid",
																				"border-right-color": "#EDF4FD",
																				"border-top-width": "0px",
																				"border-top-style": "solid",
																				"border-top-color": "#EDF4FD",
																				"border-bottom-width": "0px",
																				"border-bottom-style": "solid",
																				"border-bottom-color": "#000000",
																			},
															...
															children: [
																...
																},
																{
																	...
																	style: {
																		...
																		"background-image": "url()",
																		"border-radius": "3px",
																		"border-left": "0px solid #B6D2F6",
																		"border-bottom": "0px solid #B6D2F6",
																		"border-right": "0px solid #B6D2F6",
																		"border-top": "0px solid #B6D2F6",
																		"margin-left": "10px",
																		"margin-bottom": "10px",
																		"margin-right": "10px",
																		"margin-top": "10px",
																		...
																		"border-left-width": "0px",
																		"border-left-style": "solid",
																		"border-left-color": "#B6D2F6",
																		"border-right-width": "0px",
																		"border-right-style": "solid",
																		"border-right-color": "#B6D2F6",
																		"border-top-width": "0px",
																		"border-top-style": "solid",
																		"border-top-color": "#B6D2F6",
																		"border-bottom-width": "0px",
																		"border-bottom-style": "solid",
																		"border-bottom-color": "#B6D2F6",
																	},
																	customData: {},
																},
																{
...
export default {
	...
	actions: {
		updateDocument({ commit, rootState }, payload) {
			...
			rootState.megaPreviewInterface.methods.updateData({ documentJSON: payload });
		},
	},
	getters: {
