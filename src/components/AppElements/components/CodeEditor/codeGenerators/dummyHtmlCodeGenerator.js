...
export default function (doc, lineLength = 799) {
	...
	let out =
		"<!--\nNote: this page only contains some snippets to showcase how each setting works. You can generate an HTML from the current document under the Generate HTML section\n-->\n\n";
	...
	let directiveNode = el.getElementsByTagName("td")[0].cloneNode(true);
